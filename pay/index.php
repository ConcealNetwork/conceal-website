<!DOCTYPE html>
<html lang="en"><head>
  <title>Conceal Pay - Simplified Blockchain Payments</title>
  ...
  <div class="site-wrap">
          ...
          <div class="col-12 col-md-11 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li class="cta"><a href="https://conceal.cloud/signup"><span class="icon-pencil"></span> SIGN UP</a></li>
    ...
    <div class="site-section site-hero">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-10">
            <span class="d-block mb-3 caption" data-aos="fade-up" data-aos-delay="100">CONCEAL PAY</span>
            <h1 class="d-block mb-4" data-aos="fade-up" data-aos-delay="200">
              <span>Simplified</span> <strong>Blockchain</strong> <span>Payments</span>
            </h1>
            <a href="https://conceal.cloud/signup" class="btn-custom btnSignMain" data-aos="fade-up" data-aos-delay="400"><span class="icon-user-plus"></span><span> SIGN UP</span></a> 
            <a href="https://conceal.cloud/login" class="btn-custom btnSignMain" data-aos="fade-up" data-aos-delay="400"><span class="icon-cloud"></span><span> SIGN IN</span></a>
      ...
      <div class="container">
        <div class="row mb-5 aboutSection">
          ...
          <div class="col-lg-8 mt-8 pl-lg-8" data-aos="fade-up" data-aos-delay="200">
            <p>
              Conceal Pay makes it simple for businesses and people to receive payments on the Conceal Network.
            </p>
          </div>
        </div>
        <div class="row align-items-center speaker">
          <div class="col-lg-6 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <div class="landingPayImg landingPayImg2"></div>
          </div>
          <div class="col-lg-6 ml-auto">
            <div class="bio pl-lg-5">
              ...
              <p class="mb-4" data-aos="fade-right" data-aos-delay="400">
                Conceal Pay empowers businesses and people to easily accept payments on the Conceal Blockchain.
              </p>
            </div>
          </div>
        </div>
        <div class="row align-items-center speaker">
          <div class="col-lg-6 mb-5 mb-lg-0 order-lg-2" data-aos="fade" data-aos-delay="100">
            <div class="landingIdImg landingIdImg2"></div>
          </div>
          <div class="col-lg-6 ml-auto order-lg-1">
            <div class="bio pr-lg-5">
              ...
              <p class="mb-4" data-aos="fade-left" data-aos-delay="400">
                Conceal Pay is seamlessly integrated with the Conceal Cloud for absolute ease of use.
              </p>
            </div>
          </div>
        </div>
        <div class="row align-items-center speaker">
          <div class="col-lg-6 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <div class="landingIdImg landingIdImg3"></div>
          </div>
          <div class="col-lg-6 ml-auto">
            <div class="bio pl-lg-5">
              <h2 class="text-uppercase text-primary d-block mb-3" data-aos="fade-right" data-aos-delay="300">
              ...
              <p class="mb-4" data-aos="fade-right" data-aos-delay="400">
                Easily create URLs with a simple web page where customers and friends can send you payments.
              </p>
            </div>
          </div>
        </div>
        <div class="row align-items-center speaker">
          <div class="col-lg-6 mb-5 mb-lg-0 order-lg-2" data-aos="fade" data-aos-delay="100">
            <div class="landingPayImg"></div>
          </div>
          <div class="col-lg-6 ml-auto order-lg-1">
            <div class="bio pr-lg-5">
              <h2 class="text-uppercase text-primary d-block mb-3" data-aos="fade-left" data-aos-delay="300">
                Insanely simple payments
              </h2>
              <p class="mb-4" data-aos="fade-left" data-aos-delay="400">
                Conceal Pay makes it trivial for you or your business to receive payments online.
              </p>
            </div>
          </div>
        </div>
        <div class="row align-items-center speaker">
          <div class="col-lg-6 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <div class="landingIdImg landingIdImg5"></div>
          </div>
          <div class="col-lg-6 ml-auto">
            <div class="bio pl-lg-5">
              <h2 class="text-uppercase text-primary d-block mb-3" data-aos="fade-right" data-aos-delay="300">
              ...
              <p class="mb-4" data-aos="fade-right" data-aos-delay="400">
                Built with an API for quick integration to start receiving payments on your website.
              </p>
            </div>
          </div>
        </div>
