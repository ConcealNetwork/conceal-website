  ...
  <div class="site-wrap">
	...
	<div class="site-section site-hero">
      <div class="container">
		<div class="row align-items-center">
          <div class="col-md-10">
            <span class="d-block mb-3 caption" data-aos="fade-up" data-aos-delay="100">CONCEAL ROADMAP</span>
            <h1 class="d-block mb-4" data-aos="fade-up" data-aos-delay="200">
				<strong>The Birth </strong> of something <strong> Amazing. </strong>
            </h1>
            <a href="#downArrowBtn" class="btn-custom btnSignMain" data-aos="fade-up" data-aos-delay="400"><span class="icon-leanpub"></span><span>Click Here To View the Conceal Roadmap</span></a>
          </div>
        </div>  	  
        <div class="downArrowWrapper">
          <a href="#downArrowBtn" class="downArrow" id="downArrowBtn"></a>
			...
			<div class="timeline-area">
				<div class="container">
					<div class="timelines">
						<h2 data-aos="fade-down" data-aos-delay="100">CONCEAL ROADMAP</h2>
					</div>
