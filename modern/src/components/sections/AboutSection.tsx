      ...
      <div className="w-full max-w-[1200px] mx-auto px-4">
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[1.7rem] text-[#757575]">
              ...
              geographic location or status. All interactions, transactions and messages are
        ...
        <div className="mb-12">
            ...
            <p className="text-[1.7rem] text-[#757575]" data-tkey="mission_desc">
              ...
              embodies the principles of the Cypherpunk movement. By leveraging advanced
              cryptographic techniques, Conceal ensures that every transaction is private,
              secure, and censorship-resistant. We aim to create a decentralized financial ecosystem
              where users have full control over their funds and can transact freely without fear
              of surveillance or interference.
            </p>
        </div>
        ...
        <div className="mb-12">
          ...
          <AnimatedElement types={['dragText']}>
            <p className="text-[1.7rem] text-[#757575]" data-tkey="community_desc">
              At the heart of Conceal is a vibrant and passionate community of individuals
              dedicated to preserving privacy and advancing the Cypherpunk agenda. Our developers
              are committed to writing code that defends privacy and empowers users, following the
              Cypherpunk tradition of publishing open-source software for the benefit of all. We
              believe in decentralization not just as a technical concept but as a social
              movement, where individuals come together to reclaim their privacy and freedom.
            </p>
          </AnimatedElement>
        </div>
        ...
        <div className="mb-12">
          ...
          <AnimatedElement types={['dragText']}>
            <p className="text-[1.7rem] text-[#757575]" data-tkey="revolution_desc">
              In a world where privacy is increasingly under threat, Conceal offers a beacon of
              hope for those who value freedom, anonymity, and privacy. Join us in our mission to
              build a more private and secure future, where individuals have the power to transact
              freely and privately, without fear of censorship or surveillance. Together, we can
              make privacy a reality in the digital age.
            </p>
          </AnimatedElement>
        </div>
      </div>
