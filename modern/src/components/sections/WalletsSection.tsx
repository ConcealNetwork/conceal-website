  ...
  return (
    <section id="wallets" className="py-16 px-4 bg-[#0A0A0A] border-b border-[rgba(255,255,255,0.2)]" style={{ background: 'linear-gradient(to bottom, rgba(34,34,34,1) 0%, rgba(34,34,34,0) 30%, rgba(10,10,10,0.3) 30%, rgba(10,10,10,1) 100%)' }}>
      <div className="max-w-[66%] mx-auto">
        ...
        {/* Conceal-Core */}
        <h3 className="text-[2.4rem] text-[orange] uppercase mb-4 text-center">Conceal-Core | Full-Node Command Line Wallet</h3>
        <p className="text-[1.7rem] text-[white] mb-6 text-center">
        ...
        {/* Web Wallet Types */}
        <h3 className="text-[2.4rem] text-[orange] uppercase mb-4 text-center">Web Wallet & Paper Wallet</h3>
        <p className="text-[1.7rem] text-[white] mb-6 text-center">
      ...
      <div className="h-[3rem]">
        ...
        {/* Conceal-Mobile */}
        <h3 className="text-[2.4rem] text-[orange] uppercase mb-4 text-center">Conceal-Mobile | Lite Wallet</h3>
